...
//
//        movimientoActual.setId ( t.getId () );
//        movimientoActual.setConcept ( t.getConcept () );
//        movimientoActual.setAmount ( t.getAmount () );
//        movimientoActual.setEmpleado ( t.getEmpleado () );
//        movimientoActual.setEmpresa ( t.getEmpresa () );
//        movimientoActual.setCreatedAt ( t.getCreatedAt () );
//
//
//
//
